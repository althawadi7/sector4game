"""Step 1: BP_GrenadeLauncher — clear broken poll branch condition only."""
import unreal
...
if br:
    ...
    unreal.log("BP_GrenadeLauncher step1: old condition cleared")
unreal.EditorAssetLibrary.save_asset(PATH)
unreal.log("BP_GrenadeLauncher step1 saved")
